...
class Endpoint extends events.EventEmitter {
    ...
    static _defaultPromiseHandler(resolve, reject) {
        return (error) => !error ? resolve() : reject(error);
    }
    ...
    _notifyAndBroadcastEvent(event, ...args_) {
    ...
    newMessage(msg, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (user) {
                ...
                this._notifyAndBroadcastEvent(pxtCloudApi.Events.ChatNewMessage, Object.assign({}, msg, { name: user.name }), socket$$1);
            }
            return !!user;
        });
    }
...
class UsersEndpoint extends endpoint_1.Endpoint {
    ...
    addSelf(user, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!existed) {
                this._notifyAndBroadcastEvent(pxtCloudApi.Events.UserJoined, userId, user, socket$$1);
            }
            return existed;
        });
    }
    removeSelf(socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existed) {
                this._notifyAndBroadcastEvent(pxtCloudApi.Events.UserLeft, userId, socket$$1);
            }
            return existed;
        });
    }
...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    syncDataDiff(name, diff, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._notifyAndBroadcastEvent(pxtCloudApi.Events.WorldSyncDataDiff, { name, diff }, socket$$1);
        });
    }
    _onClientConnect(socket$$1) {
        super._onClientConnect(socket$$1);
    ...
    _clearDiff(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield new Promise((resolve, reject) => {
                this.redisClient.del(datakey, endpoint_1.Endpoint._defaultPromiseHandler(resolve, reject));
            });
        });
    }
    ...
    _persistedDiff(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const datakey = WorldDBKeys.dataDiff(name);
            return yield new Promise((resolve, reject) => {
                this.redisClient.lrange(datakey, 0, -1, endpoint_1.Endpoint._bufferPromiseHandler(resolve, reject));
            });
        });
    }
    _persistedData(name) {
        return __awaiter(this, void 0, void 0, function* () {
            yield new Promise((resolve, reject) => this._batchedDiffs.exec(endpoint_1.Endpoint._defaultPromiseHandler(resolve, reject)));
            return yield new Promise((resolve, reject) => {
                const datakey = WorldDBKeys.data(name);
                this.redisClient.get(datakey, endpoint_1.Endpoint._bufferPromiseHandler((reply) => resolve(reply ? pxtCloudApi.DataRepo.decode(reply) : {}), reject));
            });
        });
    }
    _persistData(name, data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield new Promise((resolve, reject) => {
                const datakey = WorldDBKeys.data(name);
                this.redisClient.set(datakey, pxtCloudApi.DataRepo.encode(data).toString('binary'), endpoint_1.Endpoint._defaultPromiseHandler(resolve, reject));
            });
        });
    }
}
