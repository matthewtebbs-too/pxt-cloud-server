...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    currentlySynced(name) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._datarepo.getData(name) || (yield this._persistedData(name));
        });
    }
    syncDataSource(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _initializeClient(socket$$1) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (success) {
                if (socket$$1) {
                    const alldata = yield this._allPersistedData();
                    alldata.forEach(({ name, data }) => success = success && socket$$1.emit(pxtCloudApi.Events.WorldSyncData, { name, data: pxtCloudApi.DataRepo.encode(data) }));
                }
            }
            if (success) {
                if (socket$$1) {
