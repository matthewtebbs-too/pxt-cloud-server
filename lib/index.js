...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    _pullAllData(socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            const datakeys = yield new Promise((resolve, reject) => {
                return this.redisClient.keys(WorldDBKeys.data('*'), endpoint_1.Endpoint._promiseHandler(resolve, reject));
            });
            const tencdata = [];
    ...
    _pullData(name, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (encdiff && encdiff.length > 0) {
                ...
                current = pxtCloudApi.DataRepo.applyDataDiff(current, encdiff.map(d => pxtCloudApi.DataRepo.decode(d)));
    ...
    _pushDataDiff(name, encdiff, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            encdiff.forEach(d => multi.xadd(datadiffKey, '*', endpoint_1.EndpointDBKeys.blob, d.toString('binary'), 'fat', 'cat'));
            if (multi.queue.length >= WorldEndpoint.maxExecBatchedDiffs) {
                yield new Promise((resolve, reject) => multi.exec(endpoint_1.Endpoint._promiseHandler(resolve, reject)));
                const lenDiff = yield new Promise((resolve, rejecT) => this.redisClient.xlen(datadiffKey));
