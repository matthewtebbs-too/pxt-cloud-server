...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    currentlySynced(name) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._datarepo.currentlySynced(name) || (yield this._persistedData(name));
        });
    }
    syncDataSource(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _persistDiff(name, diff) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._batchedDiffs.rpush(datakey, pxtCloudApi.DataRepo.encode(diff).toString('binary'));
        });
    }
    _persistedData(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield new Promise((resolve, reject) => {
                ...
                this.redisClient.get(datakey, (error, reply) => {
                    if (!error) {
                        resolve(reply ? pxtCloudApi.DataRepo.decode(Buffer.from(reply, 'binary')) : {});
                    }
                    else {
                        reject(error);
                    }
