...
class Endpoint extends events.EventEmitter {
    constructor(server, redisAPI, nsp) {
        super();
        this._io = null;
    ...
    connect(port_ = server_config_1$1.ServerConfig.port, host_ = server_config_1$1.ServerConfig.host) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._httpServer.listen(port_, host_, () => {
                ...
                this._redisClient = new client_redis_1$1.ClientRedis();
                this._redisClient.connect()
                    .then(() => {
                    this._worldEndpoint = new endpoint_world_1$1.WorldEndpoint(this._httpServer, this._redisClient.redisAPI);
                    resolve();
                })
