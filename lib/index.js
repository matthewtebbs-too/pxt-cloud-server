...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    syncDataSource(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return diff ? yield this.syncDataDiff(name, diff) : [];
        });
    }
    syncDataDiff(name, diff, apply, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const diff_ of diff) {
                ids.push(yield new Promise((resolve, reject) => {
            ...
            this._broadcastNotifyEvent(pxtCloudApi.Events.WorldSyncDataDiff, { name, diff }, socket$$1);
            return ids;
        });
    }
    _onClientConnect(socket$$1) {
