...
class Endpoint extends events.EventEmitter {
    ...
    _ensureInitializedClient(socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!socket$$1 || !socket$$1.connected || socket$$1.initialized) {
                return;
            }
    ...
    _onClientConnect(socket$$1) {
        setTimeout(() => __awaiter(this, void 0, void 0, function* () { return yield this._initializeClient(socket$$1); }));
    }
...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    currentlySynced(name) {
        return __awaiter(this, void 0, void 0, function* () {
            let current = this._datarepo.currentlySynced(name);
            if (!current) {
                yield this._collapseDiff(name);
                current = yield this._persistedData(name);
            }
            return current;
        });
    }
    syncDataSource(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (diff) {
                yield this.syncDataDiff(name, diff);
            }
        });
    }
    syncDataDiff(name, diff, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._persistDiff(name, diff);
            yield this._notifyEvent(pxtCloudApi.Events.WorldSyncDataDiff, { name, diff }, socket$$1);
        });
    }
    _initializeClient(socket$$1) {
        const _super = name => super[name];
        return __awaiter(this, void 0, void 0, function* () {
            let success = yield _super("_initializeClient").call(this, socket$$1);
            if (success) {
                if (socket$$1) {
                    (yield this._allPersistedData())
                        .forEach(({ name, data }) => success = success && socket$$1.emit(pxtCloudApi.Events.WorldSyncData, { name, data: pxtCloudApi.DataRepo.encode(data) }));
                }
            }
            return success;
        });
    ...
    _onClientConnect(socket$$1) {
        super._onClientConnect(socket$$1);
        socket$$1
            .on(pxtCloudApi.Events.WorldSyncDataDiff, ({ name, diff }, cb) => endpoint_1.Endpoint._fulfillReceivedEvent(this.syncDataDiff(name, diff, socket$$1), cb));
    }
    _clearDiff(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _persistedData(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield new Promise((resolve, reject) => this.redisClient.get(WorldDBKeys.data(name), endpoint_1.Endpoint._bufferPromiseHandler(reply => resolve(reply ? pxtCloudApi.DataRepo.decode(reply) : {}), reject)));
        });
    }
