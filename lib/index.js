...
class WorldEndpoint extends endpoint_.Endpoint {
    ...
    dispose() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._flushAllBatchedDiffs(true);
        });
    }
    syncDataSources() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _pushDataDiff(name, encdiff, unlock = false, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._flushBatchedDiffs(name, !batchExisted);
    ...
    _flushAllBatchedDiffs(forceFlush = false) {
        return __awaiter(this, void 0, void 0, function* () {
            this._datarepo.names.forEach((name) => __awaiter(this, void 0, void 0, function* () { return yield this._flushBatchedDiffs(name); }));
        });
    }
    _flushBatchedDiffs(name, forceFlush = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const { multi } = this._getBatchedDiff(name);
            const datadiffKey = WorldDBKeys.dataDiff(name);
