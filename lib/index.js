...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    _clearDiff(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield new Promise((resolve, reject) => {
                this.redisClient.del(datakey, endpoint_1.Endpoint._promiseHandler(resolve, reject));
            });
        });
    }
    ...
    _persistedDiff(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const datakey = WorldDBKeys.dataDiff(name);
            return yield new Promise((resolve, reject) => {
                this.redisClient.lrange(datakey, 0, -1, endpoint_1.Endpoint._buffersPromiseHandler(resolve, reject));
            });
        });
    }
    _persistedData(name) {
        return __awaiter(this, void 0, void 0, function* () {
            yield new Promise((resolve, reject) => this._batchedDiffs.exec(endpoint_1.Endpoint._promiseHandler(resolve, reject)));
            return yield new Promise((resolve, reject) => {
    ...
    _persistData(name, data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield new Promise((resolve, reject) => {
                const datakey = WorldDBKeys.data(name);
                this.redisClient.set(datakey, pxtCloudApi.DataRepo.encode(data).toString('binary'), endpoint_1.Endpoint._promiseHandler(resolve, reject));
            });
        });
    }
}
