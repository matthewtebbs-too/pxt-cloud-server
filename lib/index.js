...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    syncDataDiff(name, diff, socket$$1) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._persistDataDiff(name, diff);
    ...
    _persistDataDiff(name, diff) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (count >= WorldEndpoint._maxPersistedDiffs) {
                const diffPersisted = pxtCloudApi.DataRepo.calcDataDiff({}, yield this._persistedData(name));
                yield new Promise((resolve, reject) => {
                    this.redisClient.del(datakey, error => {
                        if (!error) {
                            resolve();
                        }
                        else {
                ...
                yield this._persistDataDiff(name, diffPersisted);
            }
            diff.forEach((diff_) => __awaiter(this, void 0, void 0, function* () {
                return yield new Promise((resolve, reject) => {
                    this.redisClient.rpush(datakey, diff_.toString('binary'), error => {
                        if (!error) {
                            resolve();
                        }
                        else {
    ...
    _persistedData(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const diff = yield new Promise((resolve, reject) => {
                const datakey = WorldDBKeys.data(name);
                this.redisClient.lrange(datakey, 0, -1, (error, reply) => {
                    if (!error) {
            ...
            return pxtCloudApi.DataRepo.applyDataDiff({}, diff);
        });
    }
}
WorldEndpoint._maxPersistedDiffs = 60;
