...
var WorldEndpoint = (function (_super) {
    ...
    WorldEndpoint.prototype.addUser = function (id, user) {
        var success = client_redis_1$1.ClientRedis.redisAPI.sadd(exports.keys.users, id, client_redis_1$1.ClientRedis.callbackHandler);
        if (success) {
    ...
    WorldEndpoint.prototype.removeUser = function (id) {
        var success = client_redis_1$1.ClientRedis.redisAPI.hdel(exports.keys.userId(id), ['username'], client_redis_1$1.ClientRedis.callbackHandler);
        if (success) {
