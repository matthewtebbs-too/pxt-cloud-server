...
class WorldEndpoint extends endpoint_1.Endpoint {
    ...
    _persistDiff(name, diff) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._persistData(name, pxtCloudApi.DataRepo.applyDataDiff(yield this._persistedData(name), diff));
        });
    }
    _persistedData(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _persistData(name, data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield new Promise((resolve, reject) => {
                const datakey = WorldDBKeys.data(name);
                this.redisClient.set(datakey, pxtCloudApi.DataRepo.encode(data).toString('binary'), error => {
                    if (!error) {
                        resolve();
                    }
                    else {
