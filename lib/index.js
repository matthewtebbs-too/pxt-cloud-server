...
class Server {
    ...
    dispose() {
        Object.keys(this._privateAPI).forEach(name => this._disposeAPI(name));
...
function startServer(port, host) {
    return Server.singleton.start(port, host).then(server => (Object.assign({}, server.publicAPI, { dispose: disposeServer })));
}
