...
class WorldEndpoint extends endpoint_base_1$1.Endpoint {
    ...
    addUser(user, cb, socket$$1) {
        ...
        return multi.exec(api_base_1$1.ackHandler(reply => {
            ...
            if (!existed) {
                this._broadcastEvent(exports.WorldEvents.userJoined, userId, user, socket$$1);
            }
            return existed;
        }, cb));
    }
    removeUser(cb, socket$$1) {
        ...
        return multi.exec(api_base_1$1.ackHandler(reply => {
            const existed = !!reply[0];
            if (existed) {
                this._broadcastEvent(exports.WorldEvents.userLeft, userId, socket$$1);
            }
            return existed;
        }, cb));
    }
    _onClientConnect(socket$$1) {
        ...
        socket$$1.on(exports.WorldEvents.addUser, (...args) => this.addUser(args[0], args[1], socket$$1));
        socket$$1.on(exports.WorldEvents.removeUser, (...args) => this.removeUser(args[0], socket$$1));
    }
}
...
var endpoint_world_1 = endpoint_world.WorldEvents;
